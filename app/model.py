...
class Account(db.Model):
    ...
    connection_id = db.Column(StrippedString, nullable=True)
    profilepic_url = db.Column(StrippedString, nullable=True)
    logo_url = db.Column(StrippedString, nullable=True)
